 ...
 */
internal const val SIMULA_SDK_VERSION = "1.2.1-dev.4"
...
internal object Telemetry {
    ...
    fun recordVideoLifecycle(
        ...
        watchedS: Double? = null,
        secondsUnmuted: Double? = null,
        secondsMuted: Double? = null,
        msToNextStepReady: Double? = null,
        secondsSinceVideoStart: Double? = null,
        on: String? = null,
        visibleS: Double? = null,
        error: String? = null,
    ) = manager?.recordVideoLifecycle(
        stage = stage,
        adFormat = adFormat,
        adUnitId = adUnitId,
        adId = adId,
