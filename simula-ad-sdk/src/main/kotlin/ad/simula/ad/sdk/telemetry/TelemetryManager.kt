...
/** Flush-time session/PPID snapshot. Both values come from one provider generation. */
internal data class TelemetryIdentity(val sessionId: String?, val primaryUserId: String?)
