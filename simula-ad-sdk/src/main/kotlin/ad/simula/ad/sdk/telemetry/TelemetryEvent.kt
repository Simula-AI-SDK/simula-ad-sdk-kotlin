...
internal data class TelemetryEvent(
    ...
    @SerialName("skoverlay_enabled") val skoverlayEnabled: Boolean? = null,
    @SerialName("skoverlay_delay_seconds") val skoverlayDelaySeconds: Int? = null,
    @SerialName("clip_index") val clipIndex: Int? = null,
    @SerialName("video_position_s") val videoPositionS: Double? = null,
    val muted: Boolean? = null,
    val pool: String? = null,
    @SerialName("duration_s") val durationS: Double? = null,
    val quartile: Int? = null,
    val reason: String? = null,
    @SerialName("paused_ms") val pausedMs: Double? = null,
    @SerialName("watched_s") val watchedS: Double? = null,
    @SerialName("seconds_unmuted") val secondsUnmuted: Double? = null,
    @SerialName("seconds_muted") val secondsMuted: Double? = null,
    @SerialName("ms_to_next_step_ready") val msToNextStepReady: Double? = null,
    @SerialName("seconds_since_video_start") val secondsSinceVideoStart: Double? = null,
    val on: String? = null,
    @SerialName("visible_s") val visibleS: Double? = null,
